...
get_username() {
    ...
    echo -e "${GREEN}Github Username set to: $username${NC}"
}
...
clone_itflow() {
    git clone https://github.com/${username}/itflow.git /var/www/${domain}
}
...
clear
echo "#########################################################"
echo "# Welcome to the ITFlow Development Installation Script #"
echo "#########################################################"
echo ""
